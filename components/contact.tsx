          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-muted-foreground">Dhanbad, Jharkhand 826001, India</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:8603331004" className="text-muted-foreground hover:text-primary transition-colors">
                        +91 8603331004
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:contact@goldensky.com"
                        className="text-muted-foreground hover:text-primary transition-colors"
                      >
                        contact@goldensky.com
                      </a>
                    </div>
                  </div>
              ...
              <div className="p-6 rounded-xl bg-card border border-border">
                <h4 className="font-bold text-lg mb-2 text-foreground">GST Information</h4>
                <p className="text-sm text-muted-foreground mb-2">GST Number:</p>
                <p className="font-mono text-foreground">10QKGPK5121Q1ZS</p>
              </div>
            </div>
